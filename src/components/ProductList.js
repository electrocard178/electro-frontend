...
const ProductList = ({ products, onEdit, onDelete, onAdd, branches = [], currentUser = null, selectedBranch = null }) => {
  ...
  return (
    ...
    >
      ...
      <div className="relative bg-white bg-opacity-95 backdrop-blur-sm p-6 rounded-3xl shadow-2xl max-w-7xl mx-auto z-10 h-full overflow-auto w-full">
          ...
          <div className="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {branches.map(branch => {
                ...
                return (
                  <div key={branchId} className={`bg-white p-3 rounded-lg shadow-sm border ${totalStock === 0 ? 'border-gray-300 bg-gray-50' :
                    ...
                    <div className="flex justify-between items-center mb-2">
                      ...
                      <span className={`px-2 py-1 rounded-full text-xs font-bold ${totalStock === 0 ? 'bg-gray-100 text-gray-800' :
                              ...
                              .map(branch => {
                                ...
                                return (
                                  <div key={branchId} className="flex justify-between items-center bg-green-50 p-2 rounded-lg border border-green-200">
                                    ...
                                    <span className={`font-bold px-2 py-1 rounded-full text-xs ${stock > 10 ? 'bg-green-100 text-green-800' :
